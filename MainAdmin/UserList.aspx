            ...
            <td>
                <asp:Panel ID="Panel1" runat="server" Height="500px" ScrollBars="Both" 
                    ...
                    <asp:SqlDataSource ID="SqlDataGetData" runat="server" 
                        ...
                        InsertCommand="INSERT INTO [Registration] ([id], [name], [occupation], [mobile]) VALUES (@id, @name, @occupation, @mobile)" 
                        UpdateCommand="UPDATE [Registration] SET [name] = @name, [occupation] = @occupation, [mobile] = @mobile WHERE [id] = @id">
                        <DeleteParameters>
